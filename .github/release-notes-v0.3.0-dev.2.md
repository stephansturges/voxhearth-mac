# VoxHearth 0.3.0 Development Preview 2

This preview restores the fast hold-to-talk response of earlier builds while
keeping the optional, fully local live transcript overlay introduced in
...
2. Download `VoxHearth-v0.3.0-dev.2-unsigned.dmg` and `SHA256SUMS` from this
