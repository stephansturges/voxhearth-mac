...
- `.github/workflows/development-release.yml` publishes the ad-hoc-signed,
  unnotarized `v0.2.1-dev.2` GitHub prerelease without Apple secrets.
...
- [ ] Create annotated tag `v0.2.1-dev.2` on that exact commit and push it.
