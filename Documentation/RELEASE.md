...
- [ ] Create annotated tag `v0.2.0-dev.1` on that exact commit and push it.
...
presented as the official `v0.2.0` release.
...
- [ ] Model revision, 21-file manifest, license, and attribution are unchanged
      or have received a fresh review.
...
- [ ] Create an annotated, signed tag `v0.2.0` on that commit and push it.

The release workflow rejects any tag other than `v0.2.0` and rejects a tag that
