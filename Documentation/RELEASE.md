...
- `.github/workflows/development-release.yml` publishes the ad-hoc-signed,
  unnotarized `v0.3.0-dev.3` GitHub prerelease without Apple secrets.
...
- [ ] Create annotated tag `v0.3.0-dev.3` on that exact commit and push it.
