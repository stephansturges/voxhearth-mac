...
`v0.2.1-dev.2` is intentionally ad-hoc signed and not notarized. Download these
files from that exact prerelease:

```text
VoxHearth-v0.2.1-dev.2-unsigned.dmg
VoxHearth-v0.2.1-dev.2.spdx.json
VoxHearth-v0.2.1-dev.2-provenance.json
VoxHearth-v0.2.1-dev.2-source.tar.gz
SHA256SUMS
```
...
gh attestation verify VoxHearth-v0.2.1-dev.2-unsigned.dmg \
  --repo stephansturges/voxhearth-mac
```

Confirm the attestation identifies
`.github/workflows/development-release.yml`, tag `v0.2.1-dev.2`, and the commit
