...
`v0.4.0-dev.7` is intentionally ad-hoc signed and not notarized. Download these
files from that exact prerelease:

```text
VoxHearth-v0.4.0-dev.7-unsigned.dmg
VoxHearth-v0.4.0-dev.7.spdx.json
VoxHearth-v0.4.0-dev.7-provenance.json
VoxHearth-v0.4.0-dev.7-source.tar.gz
SHA256SUMS
```
...
gh attestation verify VoxHearth-v0.4.0-dev.7-unsigned.dmg \
  --repo stephansturges/voxhearth-mac
```

Confirm the attestation identifies
`.github/workflows/development-release.yml`, tag `v0.4.0-dev.7`, and the commit
